...
//
//   File: ./src/org/codehaus/ldapv3/ModifyRequestSeqOf.java
//
//   Java class for ASN.1 definition ModifyRequestSeqOf as defined in
//   module LDAPv3.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>ModifyRequestSeqOf</tt>.
...
public class ModifyRequestSeqOf extends java.util.Vector implements LDAPv3
{

    /** default constructor */
    public ModifyRequestSeqOf()
    {
    }

    /** copy constructor */
    public ModifyRequestSeqOf( ModifyRequestSeqOf arg )
    {
        for ( java.util.Enumeration e = arg.elements(); e.hasMoreElements(); )
        {
            addElement( ( (ModifyRequestSeqOfSeq) ( e.nextElement() ) ) );
        }
    }
    ...
    public void decode( ASN1Decoder dec ) throws ASN1Exception
    {
        ...
        {
            ModifyRequestSeqOfSeq tmp = new ModifyRequestSeqOfSeq();
            tmp.decode( dec );
            addElement( tmp );
        }
    }
    ...
    public void encode( ASN1Encoder enc ) throws ASN1Exception
    {
        ...
        {
            ( (ModifyRequestSeqOfSeq) ( e.nextElement() ) ).encode( enc );
        }
        enc.endOf( seq_of_nr );
    }
    ...
    public void print( PrintStream os, int indent )
    {
        ...
        for ( java.util.Enumeration e = elements(); e.hasMoreElements(); )
        {
            ...
            ( (ModifyRequestSeqOfSeq) ( e.nextElement() ) ).print( os, indent + 2 );
