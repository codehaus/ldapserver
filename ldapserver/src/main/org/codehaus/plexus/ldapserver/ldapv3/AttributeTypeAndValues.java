...
//
//   File: ./src/org/codehaus/ldapv3/AttributeTypeAndValues.java
//
//   Java class for ASN.1 definition AttributeTypeAndValues as defined in
//   module LDAPv3.
...
/** This class represents the ASN.1 SEQUENCE type <tt>AttributeTypeAndValues</tt>.
...
public class AttributeTypeAndValues implements LDAPv3
{

    /** member variable representing the sequence member type of type byte[] */
    public byte[] type;
    /** member variable representing the sequence member vals of type AttributeTypeAndValuesSetOf */
    public AttributeTypeAndValuesSetOf vals = new AttributeTypeAndValuesSetOf();
    ...
    /** copy constructor */
    public AttributeTypeAndValues( AttributeTypeAndValues arg )
    {
        type = new byte[arg.type.length];
        System.arraycopy( arg.type, 0, type, 0, arg.type.length );
        vals = new AttributeTypeAndValuesSetOf( arg.vals );
    }
