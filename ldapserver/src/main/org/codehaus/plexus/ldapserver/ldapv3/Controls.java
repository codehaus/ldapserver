...
//
//   File: ./src/org/codehaus/ldapv3/Controls.java
//
//   Java class for ASN.1 definition Controls as defined in
//   module LDAPv3.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>Controls</tt>.
...
public class Controls extends java.util.Vector implements LDAPv3
{
    ...
    /** copy constructor */
    public Controls( Controls arg )
    {
        for ( java.util.Enumeration e = arg.elements(); e.hasMoreElements(); )
        {
            addElement( ( (Control) ( e.nextElement() ) ) );
        }
    }
    ...
    public void encode( ASN1Encoder enc ) throws ASN1Exception
    {
        ...
        {
            ( (Control) ( e.nextElement() ) ).encode( enc );
        }
        enc.endOf( seq_of_nr );
    }
    ...
    public void print( PrintStream os, int indent )
    {
        ...
        for ( java.util.Enumeration e = elements(); e.hasMoreElements(); )
        {
            ...
            ( (Control) ( e.nextElement() ) ).print( os, indent + 2 );
