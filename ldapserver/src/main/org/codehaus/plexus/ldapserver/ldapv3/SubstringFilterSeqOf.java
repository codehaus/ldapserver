...
//
//   File: ./src/org/codehaus/ldapv3/SubstringFilterSeqOf.java
//
//   Java class for ASN.1 definition SubstringFilterSeqOf as defined in
//   module LDAPv3.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>SubstringFilterSeqOf</tt>.
...
public class SubstringFilterSeqOf extends java.util.Vector implements LDAPv3
{
    ...
    public SubstringFilterSeqOf( SubstringFilterSeqOf arg )
    {
        ...
        {
            addElement( ( (SubstringFilterSeqOfChoice) ( e.nextElement() ) ) );
        }
    }
    ...
    public void encode( ASN1Encoder enc ) throws ASN1Exception
    {
        ...
        {
            ( (SubstringFilterSeqOfChoice) ( e.nextElement() ) ).encode( enc );
        }
        enc.endOf( seq_of_nr );
    }
