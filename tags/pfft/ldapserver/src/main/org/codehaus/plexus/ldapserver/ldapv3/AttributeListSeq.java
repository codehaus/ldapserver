...
//
//   File: ./src/org/codehaus/ldapv3/AttributeListSeq.java
//
//   Java class for ASN.1 definition AttributeListSeq as defined in
//   module LDAPv3.
...
/** This class represents the ASN.1 SEQUENCE type <tt>AttributeListSeq</tt>.
...
public class AttributeListSeq implements LDAPv3
{

    /** member variable representing the sequence member type of type byte[] */
    public byte[] type;
    /** member variable representing the sequence member vals of type AttributeListSeqSetOf */
    public AttributeListSeqSetOf vals = new AttributeListSeqSetOf();
    ...
    /** copy constructor */
    public AttributeListSeq( AttributeListSeq arg )
    {
        type = new byte[arg.type.length];
        System.arraycopy( arg.type, 0, type, 0, arg.type.length );
        vals = new AttributeListSeqSetOf( arg.vals );
    }
